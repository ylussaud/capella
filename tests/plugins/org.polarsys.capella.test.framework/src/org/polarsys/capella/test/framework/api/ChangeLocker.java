...
public class ChangeLocker extends ResourceSetListenerImpl {
  ...
  @Override
	public Command transactionAboutToCommit(ResourceSetChangeEvent event) throws RollbackException {
			throw new RollbackException(new Status(IStatus.CANCEL, FrameworkUtil.getBundle(getClass()).getSymbolicName(), "Test model can not be modified by a test artefact which is not its owner."));
		}
}
