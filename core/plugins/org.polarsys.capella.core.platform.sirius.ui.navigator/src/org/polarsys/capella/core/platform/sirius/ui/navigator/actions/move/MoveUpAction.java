...
public class MoveUpAction extends org.polarsys.capella.core.ui.toolkit.actions.move.MoveUpAction {
  ...
  public MoveUpAction() {
    super();
    setImageDescriptor(ImageExt2.getImageDescriptor(FrameworkUtil.getBundle(CapellaNavigatorPlugin.class).getSymbolicName(), IImageKeys.IMG_ENABLED_MOVE_UP));
    setDisabledImageDescriptor(ImageExt2.getImageDescriptor(FrameworkUtil.getBundle(CapellaNavigatorPlugin.class).getSymbolicName(), IImageKeys.IMG_DISABLED_MOVE_UP));
