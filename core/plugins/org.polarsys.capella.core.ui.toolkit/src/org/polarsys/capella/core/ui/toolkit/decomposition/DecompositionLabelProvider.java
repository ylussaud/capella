...
public class DecompositionLabelProvider extends MDEAdapterFactoryLabelProvider implements IBaseLabelProvider,
  ...
  ImageDescriptor implImageDescriptorFromPlugin = AbstractUIPlugin.imageDescriptorFromPlugin(FrameworkUtil.getBundle(getClass()).getSymbolicName(),
  ...
  ImageDescriptor useImageDescriptorFromPlugin = AbstractUIPlugin.imageDescriptorFromPlugin(FrameworkUtil.getBundle(getClass()).getSymbolicName(),
