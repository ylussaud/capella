    ...
    try {
      getExecutionManager(session_p).execute(new AbstractReadWriteCommand() {
        ...
        public void commandRolledBack() {
          result[0] = new Status(IStatus.ERROR, FrameworkUtil.getBundle(getClass()).getSymbolicName(), getName());
        }
        ...
        public void run() {
          try {
            ...
            result[0] = new Status(IStatus.ERROR, FrameworkUtil.getBundle(getClass()).getSymbolicName(), message, exception_p);
          }
        }
      });
