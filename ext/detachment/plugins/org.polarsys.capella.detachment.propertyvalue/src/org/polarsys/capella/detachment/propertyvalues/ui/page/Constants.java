...
public final class Constants {
	...
	static {
		...
		url = FileLocator.find(FrameworkUtil.getBundle(Constants.class), new Path("icons/full/collapseall.gif"), null); //$NON-NLS-1$
		collapsAllIcon = ImageDescriptor.createFromURL(url).createImage();
		
		url = FileLocator.find(FrameworkUtil.getBundle(Constants.class), new Path("icons/full/expandall.gif"), null); //$NON-NLS-1$
		expandAllIcon = ImageDescriptor.createFromURL(url).createImage();
		
		url = FileLocator.find(FrameworkUtil.getBundle(Constants.class), new Path("icons/full/checked.gif"), null); //$NON-NLS-1$
		checkAllIcon = ImageDescriptor.createFromURL(url).createImage();
		
		url = FileLocator.find(FrameworkUtil.getBundle(Constants.class), new Path("icons/full/unchecked.gif"), null); //$NON-NLS-1$
