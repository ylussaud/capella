...
public abstract class AbstractLabelProviderFactory {
  ...
  public static AbstractLabelProviderFactory getInstance() {
    if (null == _instance) {
      IConfigurationElement[] configurationElements = ExtensionPointHelper.getConfigurationElements(FrameworkUtil.getBundle(AbstractLabelProviderFactory.class).getSymbolicName(), LABEL_PROVIDER_FACTORY);
