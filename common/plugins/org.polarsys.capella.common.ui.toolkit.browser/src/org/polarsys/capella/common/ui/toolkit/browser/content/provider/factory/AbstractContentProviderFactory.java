...
public abstract class AbstractContentProviderFactory {
  ...
  public static AbstractContentProviderFactory getInstance() {
    if (null == _instance) {
      IConfigurationElement[] configurationElements = ExtensionPointHelper.getConfigurationElements(FrameworkUtil.getBundle(AbstractContentProviderFactory.class).getSymbolicName(), CONTENT_PROVIDER_FACTORY);
