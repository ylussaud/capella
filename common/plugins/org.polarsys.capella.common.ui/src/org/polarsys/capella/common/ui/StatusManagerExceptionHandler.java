...
public class StatusManagerExceptionHandler implements ExceptionHandler {
  ...
  protected IStatus createStatus(Exception e) {
    return new Status(IStatus.ERROR, FrameworkUtil.getBundle(getClass()).getSymbolicName(), e.getLocalizedMessage(), e);
  }
  ...
  protected IStatus extractStatus(Exception e) {
    ...
    if (e instanceof RollbackException) {
      ...
      return new Status(exceptionStatus.getSeverity(), FrameworkUtil.getBundle(getClass()).getSymbolicName(), ce.getLocalizedMessage(), ce);
    }
    return null;
  }
